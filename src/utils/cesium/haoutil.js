...
*  版权所有：Copyright by 广州欧科 木遥  http://marsgis.cn
*/
var haoutil = haoutil || {};
haoutil.version = "2.4",
...
haoutil.msg = function(t) {
    haoutil.isutil.isNull(t) ? t = "未知" : "object" == typeof t && (t = JSON.stringify(t)),
...
haoutil.system = function() {
    ...
    return {
        getRequest: function(t) {
            var e = (t = t || window).location.search
              , n = new Object;
            if (-1 != e.indexOf("?"))
                for (var r = e.substr(1).split("&"), o = 0; o < r.length; o++)
                    n[r[o].split("=")[0]] = decodeURI(r[o].split("=")[1]);
            return n
        },
        getRequestByName: function(t, e, n) {
            n = n || window;
            var r = new RegExp("(^|&)" + t + "=([^&]*)(&|$)","i")
              , o = n.location.search.substr(1).match(r);
            return null != o ? decodeURI(o[2]) : e
        },
        ...
        clone: function t(e, n) {
            if (null == e || "object" != typeof e)
                return e;
            if (null == n && (n = ["_parent", "_class"]),
            haoutil.isutil.isDate(e))
                return (r = new Date).setTime(e.getTime()),
                r;
            if (haoutil.isutil.isArray(e)) {
            ...
            r = {};
            for (var a in e)
                "function" != typeof a && -1 == n.indexOf(a) && e.hasOwnProperty(a) && (r[a] = t(e[a], n));
            return r
        },
